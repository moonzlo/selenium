# Побеждаем в очередной мини игры на умножение.
# Суть игры заключаеться в том что бы умножать числа и выбирать правильный ответ среди списка ответов.
...
driver.get("https://wikium.ru/challenge/3771/play")  # Переходим на страницу с игрой.
